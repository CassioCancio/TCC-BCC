...
\section{Literatura formal}
\label{sec:literatura-formal}
...
\begin{itemize}
    \item \textbf{Revisão por pares (\emph{peer review}):} são avaliados anonimamente por outros especialistas (\emph{blind review}) para garantir validade técnica e metodologia correta;
    \item \textbf{Indexação:} são facilmente encontrados em bases de dados bibliográficas confiáveis (IEEE \emph{Xplore}, ACM \emph{Digital Library}, \emph{Scopus}, \emph{Elsevier});
    \item \textbf{Publicação comercial/acadêmica:} são publicados por editoras ou organizações estabelecidas.
\end{itemize}

Como fonte de literatura formal foi utilizado o artigo de \citet{elsevier}. Sua apresentação está detalhada a seguir.

\subsection{\citetitle{elsevier} \parencite*{elsevier}}

Esta fonte é um artigo científico revisado por pares publicado na \emph{Information and Software Technology}, revista renomada na área de engenharia de \emph{software}, da \emph{Elsevier}. O objetivo deste artigo foi compreender melhor como os desenvolvedores estão utilizando assistentes de IA, porque não os usam em determinadas etapas de seu fluxo de desenvolvimento e quais aspectos precisam ser aprimorados no futuro.
...
\section{Literatura cinzenta}
\label{sec:literatura-cinzenta}
...
Na engenharia de \emph{software}, a literatura cinza é valiosa. Exemplos incluem:

\begin{itemize}
    \item \textbf{Relatórios técnicos (\emph{Technical Reports}):} documentos internos de empresas que detalham novas arquiteturas;
    \item \textbf{\emph{White papers}:} documentos informativos emitidos por empresas para promover ou destacar uma solução ou tecnologia;
    \item \textbf{Teses e dissertações:} embora acadêmicas, muitas vezes são consideradas cinzas até que o conteúdo seja publicado em artigo;
    \item \textbf{Normas e padrões:} documentos da ISO ou do W3C;
    \item \textbf{\emph{Blogs} de engenharia e documentação:} \emph{posts} em \emph{blogs} oficiais de engenharia ou documentação de APIs.
\end{itemize}

As apresentações das fontes de literatura cinzenta analisadas nesse trabalho estão detalhadas a seguir.

\subsection{\citetitle{gitclear2025} \parencite*{gitclear2025}}

Este relatório foi escrito pela empresa GitClear, que desenvolve ferramentas de análise de código-fonte para empresas de desenvolvimento de \emph{software}. O relatório realizou uma análise de métricas de qualidade de código de 211 milhões de linhas alteradas em 2024, sendo dois terços destas linhas advindos do compartilhamento de dados anonimizados de empresas privadas e o restante de projetos de código livre. Os pesquisadores criaram um histórico comparando as métricas observadas em pesquisas anteriores com as métricas de 2024 e a análise é feita com foco no impacto de ferramentas de IA generativa no processo de desenvolvimento de \emph{software}, considerando 2022 como o ano em que a adoção da IA na programação se iniciou.
...
\subsection{\citetitle{StackOverflow2023} \parencite*{StackOverflow2023,StackOverflow2024,StackOverflow2025}}
...
\subsection{\citetitle{gartner_ai_code_assistants_2024} \parencite*{gartner_ai_code_assistants_2024}}
...
\subsection{\citetitle{gartner2024agenticAI} \parencite*{gartner2024agenticAI}}
...
\begin{itemize}
    ...
    \item Tratar agentes de IA como colegas digitais de nível básico, equivalentes a posições júnior, ou como funcionários digitais aos quais se delega trabalho;
