...
\begin{itemize}
  \item Pesquisar como a IA generativa tem sido adotada pelas empresas de \emph{software};
  \item Construir uma evolução temporal do uso da IA pelos engenheiros;
  \item Avaliar a mudança na qualidade e nas métricas do código após a adoção da IA;
  \item Levantar impressões, usos e sentimentos dos engenheiros quanto ao uso de IA.
\end{itemize}