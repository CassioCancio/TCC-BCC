...
\begin{itemize}
  ...
  \item Documentar os resultados gerados pela IA durante o processo de desenvolvimento do sistema, incluindo os \textit{prompts} utilizados;
