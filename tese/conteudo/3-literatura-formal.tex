...
\begin{itemize}
    ...
    \item \textbf{Áreas de foco:} Considerando as atividades que os desenvolvedores menos apreciam e desejam delegar, bem como as etapas em que os assistentes de IA são utilizados, destacam-se áreas que a pesquisa precisa explorar para gerar valor imediato aos usuários. Isso inclui a escrita de testes em geral e a geração de dados e recursos para testes em particular, além da produção de artefatos em linguagem natural;
...
\begin{itemize}
    ...
    \item Entre os diferentes estágios das atividades de desenvolvimento de software, os mais utilizados pelos desenvolvedores com assistentes de IA são aqueles relacionados à geração e resumo de código. Por outro lado, atividades como aplicar diretamente o código gerado na base de código existente e identificar manualmente os pontos onde novas funcionalidades devem ser inseridas são menos comuns. Apesar disso, ainda são utilizados por uma parcela relevante de desenvolvedores.
