...
Uma pesquisa publicada na revista \emph{Nature Human Behaviour} constatou que alguns modelos de linguagem de grande porte (LLMs) apresentaram desempenho equivalente ou superior ao de seres humanos quando submetidos a testes de capacidade de rastreamento de estados mentais de pessoas \citep{Strachan2024}.
