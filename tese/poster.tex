...
\begin{tcbposter}[
    ...
    {name=riscos, below=objective, column=7, span=6}{
        De acordo com um artigo publicado no \emph{Journal Information} \\ \emph{and Software Technology (Sergeyuk, A. et al., 2025)}, os\\  desenvolvedores entrevistados preferem delegar tarefas que\\ gostam menos de fazer para ferramentas de IA e manter o\\ controle das mais prazerosas:
\vspace{0.5cm}
...
\vspace{0.5cm}
    ...
    {name=bibbox, between=gitclearVisual and footerbox, column=1, span=8}{
        ...
        \begin{itemize}
            ...
            \item \textbf{[Sergeyuk, A. et al.]} "Using AI-based coding assistants in practice".
