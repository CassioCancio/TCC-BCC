...
\begin{tcbposter}[
    ...
    \posterbox[titlebox]{name=titlebox, below=top, column=1, span=12}{
        ...
        \begin{minipage}{0.85\linewidth} % largura da coluna do texto
            ...
            Autor: Cássio Cancio | Orientadores: Paulo Meirelles e Arthur Pilone
        \end{minipage}
        \hfill
    ...
    {name=context, below=titlebox, column=1, span=6}{
        \begin{itemize}
            \item A adoção de ferramentas de IA generativa para a engenharia\\ de software (ES) é uma das grandes \textbf{tendências da indústria}.

            \item A \emph{Stack Overflow Developer Survey} aponta, desde 2023, o \textbf{crescimento da adoção de ferramentas de IA} para este fim na comunidade de desenvolvedores profissionais.
        \end{itemize}
    }
    ...
    {name=objective, below=titlebox, column=7, span=6}{
        \begin{itemize}
            ...
            \item Analisar a evolução da \textbf{percepção dos desenvolvedores} \\ sobre o uso destas ferramentas, de acordo com diversas \\ pesquisas e relatórios do mercado
    ...
    \posterbox[adjusted title = Uso de IA,
        smallmargins]
    {name=so, below=context, column=1, span=6, rowspan=1.95}{
        ...
        \begin{center}
            ...
            \includegraphics[width=18cm]{grafico-uso.png}
        \end{center}
        ...
        \begin{itemize}
            \item Em 2028, 90\% das empresas de \emph{software} usarão \emph{\textbf{AI code}} \\ \emph{\textbf{assistants}};
            \item A IA passará de 5\% (2024) para 40\% (2027) em \textbf{participação no ciclo de desenvolvimento de \emph{software}};
            \item Até 2027, 25\% dos \emph{bugs} em produção virão de \textbf{código de IA \\não revisado}.
        \end{itemize}
    ...
    {name=riscos, below=objective, column=7, span=6, }{
        De acordo com Sergeyuk, A. et al., 2025, os desenvolvedores entrevistados preferem \textbf{delegar tarefas que gostam menos}\\ para ferramentas de IA e \textbf{manter o controle das mais\\ prazerosas}:
        \vspace{0.5cm}
        ...
        \begin{itemize}
            \item 82\% utiliza para \textbf{escrever código};
            \item 40,1\% utiliza para \textbf{produzir documentação};
            \item 27,2\% utiliza para \textbf{testar código}.
        \end{itemize}
    }
    ...
    {name=gitclearText, below=riscos,
        column=7, span=6, rowspan=1.6}{

        \textbf{Queda na refatoração}
        \begin{itemize}
            \item A proporção de \textbf{linhas movidas}, forte indicador de refatoração, caiu de 24,1\% (2020) para 9,5\% (2024).
        \end{itemize}

        \vspace{0.5cm}
        
        \textbf{Aumento das duplicações de código:}
        \begin{itemize}
            \item Em 2024, pela primeira vez, a porcentagem de \textbf{linhas copiadas (12,3\%) superou as linhas movidas (9,5\%)}.
            \item A ocorrência de commits com \textbf{blocos de código duplicados cresceu} de 0,7\% (2020) para 6,66\% (2024).
        \end{itemize}
        \vspace{0.5cm}
        
        \textbf{Aumento do retrabalho:}
        \begin{itemize}
            \item O \textit{churn}, \textbf{proporção do código revertido ou refeito} em \\ menos de 2 semanas, cresceu de 3,1\% em 2020 para 5,7\%\\ em 2024.
        \end{itemize}
        
        \vspace{0.5cm}
        \textbf{Redução da durabilidade do código:}
        \begin{itemize}
            \item A proporção de linhas que em \textbf{menos de duas semanas}\\ foram alteradas foi de 60,4\% em 2020 para 69,7\% em 2024
            \item As linhas que precisaram de alterações entre \textbf{4 semanas e um \\ ano}, diminuiu de 24,7\% para 16,9\% no mesmo período.
        \end{itemize}
    }

    \posterbox[adjusted title = Tabela das Métricas (GitClear)]
    {name=gitclearVisual, below=so,
        column=1, span=6, rowspan=1.05}{

        A GitClear produziu uma análise de \textbf{211 milhões de linhas de} \\ \textbf{código} alteradas entre 2020 e 2024. O código tem origem em\\  milhares de \textbf{repositórios fechados e abertos}.

        \vspace{0.5cm}

        Os resultados das métricas das mudanças de linhas foram:
    ...
    {name=bibbox, between=gitclearVisual and footerbox, column=1, span=10}{
        \footnotesize
        \begin{itemize}
            \item \textbf{[GitClear]} Harding, W. "AI Copilot Code Quality: Evaluating 2024's Increased Defect Rate", 2025.
            \item \textbf{[Gartner]} "Principais Tendências Tecnológicas Estratégicas para 2025: IA Agêntica", 2024.
            ...
            \item \textbf{[Sergeyuk, A. et al.]} "Using AI-based coding assistants in practice". Information and Software Technology, Elsevier, 2025
            \item \textbf{[ANSSI/BSI]} "AI Coding Assistants - Security Recommendations", 2024.
        \end{itemize}
    }

    \posterbox[adjusted title = Site do TCC, smallmargins]
    {between=gitclearVisual and footerbox, column=11, span=2}{
